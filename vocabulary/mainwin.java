						...
						for(int j = 0;j < 1;){
							...
							try{
								...
								if(number <= maxnumber.getMaxNumber()){
									j++;
									reader.nextLine();
									vocabularymessage randvocabulary[] = new randVocabulary().randVocabulary(maxnumber.getMaxNumber(),number);
									System.out.println();
									System.out.println("+-------------------------+");
									System.out.println("| number | vocabulary     |");
									System.out.println("+-------------------------+");
									...
									while(i < number-1){
										...
										System.out.println(String.format("%-15s",randvocabulary[i].getVocabulary())+"|");
									}
									System.out.println("+-------------------------+");
									System.out.print("enter>");
									reader.nextLine();
